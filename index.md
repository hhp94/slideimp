...
numeric matrices (numeric matrix, samples in rows, variables in
columns). Two “meta-callers” wrap the workhorse functions
...
If [slideimp](https://github.com/hhp94/slideimp) is useful in your work,
please cite:
...
- [`mat_miss()`](https://hhp94.github.io/slideimp/reference/mat_miss.md):
  Efficient column/row missing statistics.
