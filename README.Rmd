...
* Calculate errors using `compute_metrics()` or [`{yardstick}`](https://github.com/tidymodels/yardstick) functions.
```{r}
...
* For K-NN without `{RcppThread}`, PCA imputation, and custom functions (see vignette), set up parallelization with `mirai::daemons()`.
