...
* `pca_imp()`: Optimized [`missMDA::imputePCA()`](http://factominer.free.fr/missMDA/PCA.html)
...
Supports `subset` imputation to restrict work to specific columns (e.g.,
clock CpGs) for very fast targeted imputation.
...
> Pham, H., Lombroso, A. P., Cevik, E. C., Taylor, H. S., & O'Donnell, K. J. (2026). slideimp: efficient imputation of DNA methylation data. *Bioinformatics*, 42(6), btag318. https://doi.org/10.1093/bioinformatics/btag318
