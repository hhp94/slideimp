...
pca_imp_internal_cpp <- function(X, miss, ncp, scale, regularized, threshold, init, maxiter, miniter, row_w, coeff_ridge, partial) {
    .Call(`_slideimp_pca_imp_internal_cpp`, X, miss, ncp, scale, regularized, threshold, init, maxiter, miniter, row_w, coeff_ridge, partial)
}
