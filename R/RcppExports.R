...
pca_imp_internal_cpp <- function(obj, eligible_idx, ncp, scale, regularized, threshold, init, maxiter, miniter, row_w, coeff_ridge) {
    .Call(`_slideimp_pca_imp_internal_cpp`, obj, eligible_idx, ncp, scale, regularized, threshold, init, maxiter, miniter, row_w, coeff_ridge)
}
...
impute_knn_brute <- function(obj, k, grp_impute, grp_miss_no_imp, grp_complete, method, dist_pow, cache = TRUE, cores = 1L) {
    .Call(`_slideimp_impute_knn_brute`, obj, k, grp_impute, grp_miss_no_imp, grp_complete, method, dist_pow, cache, cores)
}
