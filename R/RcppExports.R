...
fastSVD_triplet <- function(A, row_w, ncp, tol = 1e-15) {
    .Call(`_slideimp_fastSVD_triplet`, A, row_w, ncp, tol)
}

pca_imp_internal_cpp <- function(X, miss, ncp, scale, method, threshold, init, maxiter, miniter, row_w, coeff_ridge) {
    .Call(`_slideimp_pca_imp_internal_cpp`, X, miss, ncp, scale, method, threshold, init, maxiter, miniter, row_w, coeff_ridge)
}
