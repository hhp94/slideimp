...
pca_imp_internal_cpp <- function(obj, eligible_idx, ncp, scale, regularized, threshold, init, maxiter, miniter, row_w, coeff_ridge, warmup_iters = 50L, lobpcg_tol = 1e-8, lobpcg_maxiter = 15L) {
    .Call(`_slideimp_pca_imp_internal_cpp`, obj, eligible_idx, ncp, scale, regularized, threshold, init, maxiter, miniter, row_w, coeff_ridge, warmup_iters, lobpcg_tol, lobpcg_maxiter)
}
