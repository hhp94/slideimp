...
pca_imp_internal_cpp <- function(obj, eligible_idx, ncp, scale, regularized, threshold, init, maxiter, miniter, row_w, coeff_ridge, warmup_iters, lobpcg_tol, lobpcg_maxiter) {
